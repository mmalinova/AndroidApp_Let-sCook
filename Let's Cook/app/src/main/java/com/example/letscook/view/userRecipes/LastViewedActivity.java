package com.example.letscook.view.userRecipes;
...
public class LastViewedActivity extends AppCompatActivity {
    private int id;
...
//                      });
                    ...
                    Animatoo.animateSlideDown(LastViewedActivity.this);
                    profile.setColorFilter(Color.parseColor("#FFFEF6D8"));
                }
            }
        });
        ...
        actionText.setText(LAST_VIEWED);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                Animatoo.animateZoom(LastViewedActivity.this);
                return true;
            }
        });
    }
